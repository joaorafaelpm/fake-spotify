...
export default async function accessTokenHandler(req, res) {
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            //* Não é necessário fazer mais nada com o access token e o refresh token, a partir de agora, vamos usa-lo na página que fez o POST para essa (/authhandler), é lá que recebemos o access token e o refresh token de resposta no JSON deste POST de agora!
